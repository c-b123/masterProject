...
print(classification_report(d["label"], d["distilBERT_market"], target_names=["negative", "neutral", "positive"]))

# Get confusion matrix
cm = confusion_matrix(d["label"], d["distilBERT"], labels=["negative", "neutral", "positive"])
